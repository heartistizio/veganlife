...
This should be an remastered version of [vegan option](https://github.com/squeek502/VeganOption) for the Minecraft Version 1.16.4. It isn't contain every feature from Vegan Option and some recipes have change.
